      ...
      <MuiThemeProvider theme={theme}>
        <Container>
          ...
          <p>
            ...
            property rights related to it, still belong to Tim O'Connor.
          </p>{' '}
          <p>
            Tim O'Connor is committed to ensuring that the app is as useful and
          ...
          <p>
            The Ask Mittens app stores and processes personal data that you have
            ...
            mean that the Ask Mittens app won’t work properly or at all.
          </p>{' '}
          <div>
            <p>
          ...
          <p>
            You should be aware that there are certain things that Tim O'Connor
            ...
            provider, but Tim O'Connor cannot take responsibility for the app
          ...
          <p>
            Along the same lines, Tim O'Connor cannot always take responsibility
            ...
            it on to avail the Service, Tim O'Connor cannot accept
            responsibility.
          </p>{' '}
          <p>
            With respect to Tim O'Connor’s responsibility for your use of the
            ...
            so that we can make it available to you. Tim O'Connor accepts no
          ...
          <p>
            ...
            to keep using the app. Tim O'Connor does not promise that it will
          ...
          <p>These terms and conditions are effective as of 2020-06-02</p>{' '}
          <p>
            <strong>Contact Us</strong>
          </p>{' '}
          <p>
            If you have any questions or suggestions about my Terms and
            Conditions, do not hesitate to contact me at askmittens1@gmail.com.
          </p>{' '}
          <p>
